...
int main() {
    cout << "\t\t\tWelcome to Escape to Victory\n\n";
    cout << "Help Adam to get to the finish!\n\n";
    ...
    cout << "After you're done, hit enter and get Adam to the finish using the following controls:\n";
    cout << "A/a = move left\n" << "S/s = move down\n" << "W/w = move up\n" << "D/d = move right\n\n";
    cout << "HAVE FUN!!!\n";
